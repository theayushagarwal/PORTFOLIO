...
export function WorkspacePanel({ project }: { project: Project }) {
  ...
  const [transitionStage, setTransitionStage] = useState<'entering' | 'ready' | 'exiting'>('entering');
      ...
      >
          ...
          <section id="ws-sec-overview" className="scroll-mt-32 space-y-12">
            <div className="border-b border-white/5 pb-6">
              ...
              <h3 className="font-display text-4xl font-semibold text-foreground mt-2">{project.name}</h3>
              <p className="mt-2 text-xs text-subtle">
                {project.name === "Vurlo" ? "Built in 10 Days • React 19 • TanStack Start" :
                 project.name === "Veltrix" ? "Autonomous Run • Python • Gemini API" :
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="md:col-span-2 space-y-6">
                <DeviceFrame label={`${project.name.toLowerCase()}/hero.webp`} noPadding className="border-white/10 shadow-2xl overflow-hidden bg-black/40">
                  {project.image ? (
                    <img src={`${project.image}?v=1.2`} alt="Hero view" className="w-full object-cover object-top max-h-[360px]" />
                  ) : (
              ...
              <div className="rounded-xl border border-white/10 bg-card p-6 flex flex-col justify-between gap-6 shadow-lg relative">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-2 text-xs text-foreground/80 leading-relaxed font-medium">{project.summary}</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-4">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-foreground/90 font-semibold truncate">{project.role}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-foreground/90 font-semibold">{project.year}</p>
                    </div>
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-foreground/90 font-semibold">
                        {project.name === "Vurlo" ? "Production SaaS" :
                         project.name === "Veltrix" ? "2 posts / day (auto)" :
                         "Daily scan @ 2AM UTC"}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-foreground/90 font-semibold truncate">
                        {project.name === "Vurlo" ? "React 19 / Firebase" :
                         project.name === "Veltrix" ? "Python / Playwright" :
                         "FastAPI / SQLite"}
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex gap-6 overflow-x-auto pb-4 scrollbar-thin select-none">
                ...
                {project.secondaryImage && (
                  <div className="flex-none w-[85vw] sm:w-[480px]">
                    <DeviceFrame label={project.secondaryLabel || "Admin console"} noPadding className="border-white/10 overflow-hidden shadow-md">
                      <img src={`${project.secondaryImage}?v=1.3`} alt="Secondary screenshot" loading="lazy" className="w-full object-cover object-top max-h-[300px]" />
                    </DeviceFrame>
                  </div>
                )}
              </div>

...
import { LighthouseDial } from "./widgets/LighthouseDial";
import { ArchitectureNode } from "./widgets/ArchitectureNode";
import { ScenarioTimeline } from "./widgets/ScenarioTimeline";
import { StepSequence, ChallengeCard } from "./widgets/ChallengeCard";

export function WorkspacePanel({ project, onClose }: { project: Project; onClose?: () => void }) {

...
const VCENTRE_BREADCRUMB_JSON_LD = JSON.stringify({
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  itemListElement: [
    {
    ...
    },
    {
      ...
      position: 3,
      name: "Vcentre",
      item: "https://theayush.pages.dev/projects/vcentre",
    },
  ],
});
...
function VcentreCaseStudy() {
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: VCENTRE_BREADCRUMB_JSON_LD }}
      />
